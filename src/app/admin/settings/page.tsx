    ...
    <div>
      ...
      <div className="grid lg:grid-cols-3 gap-5">
            ...
            {theaters.map((t) => (
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-xl border transition-all text-sm
                  ${selected?.id === t.id ? "bg-amber-500/15 border-amber-500/40 text-amber-400" : "bg-white/5 border-white/10 text-white/60 hover:text-white hover:border-white/20"}`}
              >
        ...
        <div className="lg:col-span-2">
          {selected ? (
            <div className="bg-[#0a0d12] border border-white/[0.06] rounded-2xl p-6">
                ...
                <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between font-bold text-base border-t border-white/10 pt-2">
                      <span>Total</span>
                      <span className="text-amber-400">₹{(sampleOrder + tax + pkg + svc).toFixed(0)}</span>
                    </div>
                  </div>
                </div>
