...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0D0D0F] text-white flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <Link
          href="/order"
          className="block w-full bg-[#C9A84C] hover:bg-[#D4B863] text-black font-bold py-4 rounded-xl text-lg transition-colors"
        >
          Start Ordering 🍿
        </Link>
